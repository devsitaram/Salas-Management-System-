...
public class SaleConstants {
    ...
    public final String UPDATE_ITEM_DATA = "Update ADMIN.items Set item_name = ?, prices = ?, item_qty = ?, supply_date = ?, supplier_id = ? WHERE item_no = ?";
    ...
    public final String SELCT_CUSTOMER_DNAME_PASSWORD = "Select customer_name, password from ADMIN.customers";
}
